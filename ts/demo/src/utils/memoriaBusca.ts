// ----------------------------------------------------------------------
// Sinal global "o Repositório está sendo consultada".
// A barra de prompt (header) liga o sinal enquanto a pergunta roda no modo
// Memória; o grafo da tela Repositório escuta e "pensa" (anima) enquanto isso —
...
/** Liga/desliga uma busca em andamento no Repositório. */
...
/** Há alguma busca no Repositório em andamento agora? */

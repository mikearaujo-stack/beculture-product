        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5">
          <header className="flex flex-col gap-1">
            <PageTitle
              help={{
                description: (
                  <>
                    <p>
                      Os <strong>Relatórios</strong> mostram como o seu time usa
                      o BeHuman: acessos, grupos criados, documentos gerados,
                      performance dos squads e ações executadas.
                    </p>
                    <p>
                      Filtre por categoria ou status, ordene a lista, alterne
                      entre visão em tabela e em cards e abra o relatório
            ...
            <p className="dark:text-dark-300 max-w-2xl text-sm text-gray-500">
              Acompanhe como o seu time usa o BeHuman: acessos, grupos criados,
              documentos gerados, performance dos squads e ações executadas.
              Filtre por categoria ou status e acesse o relatório completo.
            </p>
          </header>
              ...
              >
                ...
                <td className="px-4 py-3">
                  <Button
                    ...
                    color="primary"
                    className="text-xs-plus h-8 gap-1.5 rounded-lg px-3"
                  >
  ...
  return (
    <Card className="flex h-full flex-col overflow-hidden">
      <div className="flex flex-1 flex-col p-4">
        ...
        <p className="text-primary-600 dark:text-primary-400 text-tiny mt-1 font-medium">
          {item.categoria}
        </p>
        <p className="dark:text-dark-300 text-xs-plus mt-2 line-clamp-2 text-gray-500">
          {item.objetivo}
        </p>
        <dl className="dark:text-dark-300 text-tiny mt-3 grid grid-cols-1 gap-1 text-gray-400">
          <div>

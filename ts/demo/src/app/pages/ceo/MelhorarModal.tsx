...
export function MelhorarModal({ isOpen, close, onMinimize }: Props) {
  ...
  // Não há título nesta ação — a nota do Repositório usa a primeira linha do texto.
  const titulo =
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        {resumo && (
          <div className="text-xs-plus rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-400">

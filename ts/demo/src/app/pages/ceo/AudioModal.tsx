                  ...
                  {resumo !== null ? (
                        ...
                        <div className="min-w-0">
                          ...
                          {salvo && (
                            <p className="flex items-center gap-1 text-xs text-emerald-600 dark:text-emerald-400">
                              <CheckCircleIcon className="size-4" /> Salvo no
                    ...
                    >
                      <p className="dark:border-primary-500/20 dark:bg-primary-500/10 border-primary-200 bg-primary-50 text-xs-plus dark:text-dark-200 rounded-lg border px-3 py-2 text-gray-600">
                        A IA <b>transcreve o áudio</b> (OpenAI Whisper) e gera
                        um <b>resumo</b> (com as conexões Obsidian ao final),
                        salvo no Repositório (Reuniões).
                      </p>
                      ...
                      <div className="flex justify-end">
                        <Button
                          ...
                          className="gap-2"
                        >
                          <MicrophoneIcon className="size-5" /> Transcrever e
                          resumir
                        </Button>
                      </div>
                    </form>

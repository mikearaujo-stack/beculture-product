...
import { getCurrentProduct, getTitleForPath } from "@/app/navigation/ceoOs";
            ...
            help={{
              description: (
                <>
                  ...
                  <p>
                    Em breve ela vai reunir aqui as funcionalidades desta seção.
                    Enquanto isso, o conteúdo aparece como um espaço reservado.
                  </p>
                </>
              ),
            }}

...
// "Gravar na Memória" envia a nota para a API real de Memória (aparece no
...
export default function Notas() {
  ...
  // que desenha o grafo, não o store de Diretrizes.
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-0.5">
              ...
              help={{
                description: (
                  <>
                    ...
                    <p>
                      Quando uma nota importar, use <strong>Gravar na Memória</strong> para enviá-la ao grafo da IA, ou as ações de IA (Apresentação, Artigo e Melhorar) para transformar o conteúdo direto na tela de IA.
                    </p>
                  </>
                ),
              }}
            ...
            <p className="dark:text-dark-300 text-sm text-gray-400">
              Organize suas notas por assunto e grave o que importa na Memória.
            </p>
          </div>
        </div>
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex shrink-0 items-center gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                            <button
                              ...
                              aria-label="Gravar na Memória"
                              title="Gravar na Memória"
                            >
              ...
              <>
                ...
                <div className="mt-4">
                  <Textarea
                    ...
                    placeholder="Escreva a nota… (“[[” conecta à Memória)"
                  />
                </div>
...
// ----------------------------------------------------------------------
// Modal de confirmação para gravar a nota na Memória — permite escolher o tema
// (= pasta da Memória) onde a memória será registrada.
// ----------------------------------------------------------------------
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="dark:text-dark-300 text-xs-plus text-gray-500">
                    A nota vira uma memória e passa a aparecer no grafo.
                  </p>
                </div>
              </div>
              <Button

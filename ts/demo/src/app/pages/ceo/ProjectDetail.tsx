              ...
              <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                ...
                <Card title="E-mails" className="lg:col-span-2">
                  {project.emails.length > 0 ? (
                      ...
                      {project.emails.map((e) => (
                        <li key={e.id} className="flex items-start gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              removeEmailFromProject(project.id, e.id)
                            }
                    ...
                    <Empty>
                      Nenhum e-mail salvo. Use “Salvar no Grupo” na página de
                      E-mail.
                    </Empty>
                  )}
                </Card>
                ...
                <Card title="Slack" className="lg:col-span-2">
                  {project.slack.length > 0 ? (
                      ...
                      {project.slack.map((s) => (
                        <li key={s.id} className="flex items-start gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              removeSlackFromProject(project.id, s.id)
                            }
                    ...
                    <Empty>
                      Nenhuma conversa salva. Use “Salvar no Grupo” na página de
                      Slack.
                    </Empty>
                  )}
                </Card>
                        ...
                        {project.files.length > 0 ? (
                          project.files.map((f) => (
                            <Row key={f.id}>
                              ...
                              <span className="dark:text-dark-300 text-tiny shrink-0 font-mono text-gray-400">
                                {formatBytes(f.size)}
                              </span>
                            </Row>
                          ))

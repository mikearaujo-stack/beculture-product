...
const apps: App[] = [
  {
    ...
    color: "info",
    name: "Chat App",
    text: "beculture prebuilt Messaging UI kit includes designs for social chat.",
    path: "/apps/chat",
  },
  {
    id: randomId(),
  ...
  },
  {
    ...
    color: "secondary",
    name: "File Manager",
    text: "beculture File Manager UI Kit is designed with modern design trends.",
  ...
  },
  {
    ...
    color: "primary",
    name: "Todo App",
    text: "beculture Todo UI kit is a simple to-do list and an task management app.",
    path: "/apps/todo",
  },
  {
    id: randomId(),
    ...
    color: "warning",
    name: "Ai Chat App",
    text: "beculture Ai Chat is a prebuild AI chatbot that writes text. You can use it to write stories, messages, or programming code.",
    path: "/apps/ai-chat",
  },
  {
    id: randomId(),
    ...
    color: "error",
    name: "Mail App",
    text: "beculture prebuilt Mail UI kit includes designs for email system.",
    path: "/apps/mail",
  },
  {
    id: randomId(),
    ...
    text: "beculture NFT Store UI Kit is responsive and high-quality UI design kit for the NFT marketplace.",
    path: "/apps/nft-1",
  },
  {
    id: randomId(),
  ...
  },
  {
    ...
    color: "warning",
    name: "Point of Sales",
    text: "beculture POS UI Kit is responsive and high-quality UI design kit for the Point of sale system.",
    path: "/apps/pos",
  },
  {
    id: randomId(),
    ...
    color: "primary",
    name: "Travel",
    text: "beculture Travel UI Kit is responsive and high-quality UI design kit for the travel agancy wesites.",
    path: "/apps/travel",
  },
];
      ...
      <div className="transition-content px-(--margin-x) pb-8">
        <div className="mt-12 text-center">
          ...
          <h3 className="dark:text-dark-100 mt-3 text-xl font-semibold text-gray-800">
            beculture Applications
          </h3>
          <p className="mt-0.5 text-base">
            List of prebuilt applications of beculture
          </p>
        </div>

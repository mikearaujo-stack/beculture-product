...
export function ProductSwitcher() {
  ...
  return (
    <Menu as="div" className="relative inline-flex w-full">
      <MenuButton
        className={clsx(
          "dark:hover:bg-dark-300/10 flex w-full items-center gap-0.5 rounded-lg px-2 py-2 text-start outline-hidden transition-colors hover:bg-gray-100",
      ...
      >
        ...
        />
        <span className="dark:text-dark-50 ml-1 min-w-0 flex-1 truncate text-xs-plus font-semibold text-gray-800">
          {current.name}
        </span>

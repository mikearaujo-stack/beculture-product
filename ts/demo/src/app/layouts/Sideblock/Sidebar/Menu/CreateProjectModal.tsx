...
function CreateProjectForm({
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    // Todo grupo tem uma pasta própria no Repositório: é ali que suas conversas e
    // documentos viram .md. Criamos aqui, ainda dentro do gesto do clique — é o
    // que permite pedir a permissão de escrita na Pasta do Repositório.
    if (memoriaVaultSupported()) {
      criarPastaDoGrupo({
        ...
        if (r.ok) {
          toast("Grupo criado", {
            description: `Pasta “${r.pasta}” criada no Repositório.`,
          });
        } else {

 ...
 * organização ativa. Trocar o valor abre aquele contexto. A ação
 * "+ Criar novo repositório" abre um modal (não é um item da lista).
 */
...
import { CriarRepositorioModal } from "./CriarRepositorioModal";
...
export function ContextoSelect() {
  ...
  return (
    <>
          ...
          >
            ...
            <MenuItem>
              {({ focus }) => (
                ...
                >
                  <PlusIcon className="size-4 shrink-0" strokeWidth="1.8" />
      ...
      <CriarRepositorioModal
        isOpen={criando}
        close={() => setCriando(false)}
      />
    </>
  );
}

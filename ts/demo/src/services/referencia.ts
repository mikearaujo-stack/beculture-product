// Coleta a "referência" do cliente para cruzar com o Repositório no prompt
// ("Pergunte ao seu Repositório"). São os dados que o usuário mantém localmente no
// navegador — Notas e To-do's — e que o backend (/ai/prompt) aceita no campo
// `referencia`. Sem isto, a barra enviava só o Repositório (Regras) do backend
 ...
 * Retorna "" quando não há nada — o backend então usa só o Repositório.
 */
